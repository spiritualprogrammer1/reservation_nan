...
<div class="container-login100" style="background: rgb(156, 73, 255)">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30 animated bounceInLeft">
        <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
            ...
            <div class="wrap-input100 validate-input m-b-25{{ $errors->has('password') ? ' has-error' : '' }}" data-validate = "Entrer votre password">
            ...
            <a href="{{url('passwordreset.nan')}}">Mot de passe oublié?</a>
